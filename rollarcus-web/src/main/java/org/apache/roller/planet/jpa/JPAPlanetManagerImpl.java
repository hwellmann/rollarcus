...
package org.apache.roller.planet.jpa;
...
public class JPAPlanetManagerImpl extends AbstractManagerImpl implements PlanetManager {
    ...
    public void saveGroup(PlanetGroup group) throws WebloggerException {
    ...
    public List getTopSubscriptions(
            PlanetGroup group, int offset, int len) throws WebloggerException {
        List result = null;
        if (group != null) {
    ...
    public PlanetGroup getGroup(String handle) throws WebloggerException {
    ...
    public List getGroupHandles(Planet planet) throws WebloggerException {
    ...
    public List getGroups(Planet planet) throws WebloggerException {
    ...
    public List getEntries(Subscription sub, int offset, int len) throws WebloggerException {            
        if (sub == null) {
    ...
    public List getEntries(PlanetGroup group, int offset, int len) throws WebloggerException {
        return getEntries(group, null, null, offset, len);
    }

    public List getEntries(PlanetGroup group, Date startDate, Date endDate, int offset, int len) throws WebloggerException {
